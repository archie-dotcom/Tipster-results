...
def main() -> None:
    ...
    # Load data from a specified directory.  Each CSV in this folder will be read
    # and concatenated into a single dataframe.  You can update the folder
    # contents (add or replace CSVs) to refresh the app’s data.
    ...
    if df_raw.empty:
        st.info(
            "No data found. Please place your weekly CSVs into the 'data' folder "
            "(or set the BETFAIR_DATA_DIR environment variable) and reload the app."
        )
        return
